...
NOT_CORRECT_PASSWORD_FORMAT_MESSAGE = 'فرمت رمز عبوری که وارد کردی درست نیست! یه دور دیگه واردش کن.'
NOT_AN_URL_MESSAGE = 'چیزی که وارد کردی لینک نیست! لطفا یه لینک معتبر بفرست.'
DIDNT_UNDERSTAND_MESSAGE = 'ببخشید؟ متوجه نشدم!'

### AUTH
REGISTER_SET_PASSWORD_MESSAGE = 'حالا رمز عبورت رو برام بفرست. طول رمزت باید حداقل ۸ کاراکتر باشه و دارای حداقل یگ حروف بزرگ انگلیسی، یک رقم و یک کاراکتر خاص باشه.'
REGISTER_COMPLETED_MESSAGE = 'ثبت نام با موفقیت انجام شد!'
SEND_EMAIL_MESSAGE = 'لطفا ایمیلت رو برام بفرست!'
SEND_PASSWORD_MESSAGE = 'حالا لطفا رمزت رو برام بفرست.'
